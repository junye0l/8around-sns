...
/**
 * 로그인 뒤 화면들의 뼈대. 왼쪽 메뉴와 가운데 칸이다.
 * 레이아웃은 화면을 옮겨도 다시 그려지지 않아서 메뉴는 그대로 있고 아래 `loading.tsx`만 바뀐다. 결정 0028.
 *
 * 1024px 이상에서 메뉴 220px, 칸 사이 24px, 가운데 600px에 좌우 여백 24px을 더한 892px이 최대 폭이다 (`docs/DESIGN.md` 반응형).
 *
...
export default async function MainLayout({ children }: LayoutProps<"/">) {
	...
	return (
		<div className="mx-auto flex w-full max-w-223 flex-1 md:gap-6 md:pr-6 lg:pl-6">
