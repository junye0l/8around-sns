...
import { listFollowers, listFollowingIds } from "@/lib/queries/follow";
...
/**
 * 이 사람을 팔로우하는 사람들. 큰 제목은 그 사람 이름이고, 아래 세그먼트로 팔로워와 팔로잉을 오간다.
 *
 ...
 */
export default async function Page({ params }: PageProps<"/u/[id]/followers">) {
