...
export function Button({
	...
	return (
		<button
			...
			className={`w-full rounded-md px-4 py-3 text-body font-semibold transition-colors duration-[var(--motion-fast)] ease-(--ease-standard) ${VARIANTS[variant]} ${className}`}
			{...props}
		>
			{children}
		</button>
