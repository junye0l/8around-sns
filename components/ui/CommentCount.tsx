...
export function CommentCount({
	...
	return (
		<Link
			...
			className="-m-2 inline-flex items-center gap-1 rounded-md p-2 text-body-sm text-fg-muted transition-colors duration-[var(--motion-fast)] ease-(--ease-standard) hover:bg-background hover:text-fg"
			href={href}
		>
